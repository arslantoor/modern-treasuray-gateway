...
function MakePayment() {
    ...
    const [paymentTypes] = useState(["wire", "provexchange"]);
    ...
    return (<React.Fragment>
        ...
        <div className="container card mt-5">
            ...
            <div className="row text-center justify-content-center">
                <Link to="/counter-party-transaction" className="btn justify-content-center btn-secondary w-25">
                    create counter party payment
                </Link>
            </div>
